...
#   ./tests/integration/run_tests_in_docker.sh              # Run all integration tests
#   ./tests/integration/run_tests_in_docker.sh -k "rps"     # Run only RPS tests
#   ./tests/integration/run_tests_in_docker.sh --verbose    # Run with verbose output
