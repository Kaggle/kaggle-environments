...
export class Player {
  ...
  constructor(container: HTMLElement, adapter: GameAdapter) {
    ...
    // Clear the container and add our new structure
    this.container.innerHTML = "";
    this.container.appendChild(playerDiv);

    // 2. Create the controls and store references
    ...
    // 3. Append controls to the controls container
    ...
    // 4. Wire up event listeners ONCE
