...
export function renderer({ agents, replay, parent, step }: RendererOptions) {
  ...
  const colors = {
    ...
    blue: '#30DFFC',
    purple: '#FF48D8',
    players: ['#FFFFFF', '#68DCFB', '#7BDF4F', '#EC7E79', '#AD59EA', '#F4AFF8', '#F0E524', '#90AAFF'],
  };
  ...
  const paths = {
    ...
    pizzaPepperoni: [
      ...
      'M163.3,181.6c-1.5-0.6-3.2-1-4.8-1c-6.9,0-12.4,5.6-12.4,12.4c0,5,3,9.5,7.6,11.4c0.1,0.1,0.3,0.1,0.4,0.1   c0.4,0,0.8-0.2,0.9-0.6c0.2-0.5-0.1-1.1-0.5-1.3c-3.9-1.6-6.4-5.4-6.4-9.6c0-5.7,4.7-10.4,10.4-10.4c1.4,0,2.8,0.3,4.1,0.8   c0.5,0.2,1.1,0,1.3-0.5C164,182.4,163.8,181.8,163.3,181.6z',
    ],
    chiliBody: [
    ...
    donutSprinkles: [
      ...
      'M165.2,162.5c-0.6,0-1.2-0.2-1.7-0.6c0,0,0,0,0,0c-1.1-0.9-1.2-2.6-0.3-3.6l7.6-8.8c0.4-0.5,1.1-0.8,1.8-0.9    c0.7-0.1,1.3,0.2,1.9,0.6c0.5,0.4,0.8,1.1,0.9,1.8s-0.2,1.4-0.6,1.9l-7.6,8.8C166.6,162.2,165.9,162.5,165.2,162.5z M164.8,160.3    c0.2,0.2,0.6,0.2,0.8-0.1l7.6-8.8c0.1-0.1,0.1-0.3,0.1-0.4c0-0.2-0.1-0.3-0.2-0.4    c-0.1,0-0.3,0.1-0.4,0.2l-7.6,8.8C164.5,159.7,164.6,160.1,164.8,160.3L164.8,160.3z',
    ...
    cakeFrosting: [
      'M200.9,153.3l-22-39.2c2.2-1.2,3.6-3.5,3.6-6.1c0-3.8-3.1-6.9-6.9-6.9c-2.9,0-5.4,1.8-6.4,4.4   c-1.3-1.2-3-2-4.9-2c-2.9,0-5.4,1.8-6.4,4.3c-1.3-1.4-3.1-2.4-5.2-2.4c-2.7,0-5.1,1.6-6.2,3.9c-1.3-1.8-3.3-2.9-5.6-2.9   c-2.9,0-5.4,1.8-6.4,4.4c-1.3-1.5-3.1-2.4-5.2-2.4c-3.8,0-6.9,3.1-6.9,6.9c0,3.8,3.1,6.9,6.9,6.9c0,0,0.1,0,0.1,0l93.8,29.6c0.1,0,0.2,0,0.3,0   c0.3,0,0.6-0.1,0.8-0.4C201.1,154.1,201.2,153.7,200.9,153.3z M100.9,118.3c0-2.7,2.2-4.9,4.9-4.9c2.7,0,4.9,2.2,4.9,4.9   c0,0.6,0.4,1,1,1s1-0.4,1-1c0-0.7-0.1-1.3-0.3-1.9c0,0,0-0.1,0-0.1c0-2.7,2.2-4.9,4.9-4.9c2.7,0,4.9,2.2,4.9,4.9c0,0.6,0.4,1,1,1   s1-0.4,1-1c0-0.3,0-0.5,0-0.8c0-0.1,0-0.1,0-0.2c0-2.7,2.2-4.9,4.9-4.9c2.7,0,4.9,2.2,4.9,4.9c0,0.6,0.4,1,1,1   s1-0.4,1-1c0-0.6-0.1-1.2-0.2-1.8c0-0.1,0-0.1,0-0.2c0-2.7,2.2-4.9,4.9-4.9c2.7,0,4.9,2.2,4.9,4.9c0,0.6,0.4,1,1,1   s1-0.4,1-1   c0-0.3,0-0.5,0-0.8c0-0.1,0-0.1,0-0.2c0-2.7,2.2-4.9,4.9-4.9c2.7,0,4.9,2.2,4.9,4.9c0,0.6,0.4,1,1,1s1-0.4,1-1   c0-0.7-0.1-1.3-0.3-1.9c0,0,0,0,0-0.1c0-2.7,2.2-4.9,4.9-4.9c2,0,3.6,1.2,4.4,2.8c0,0.1,0.1,0.2,0.2,0.3c0.2,0.6,0.3,1.1,0.3,1.8   c0,0.6,0.4,1,1,1s1-0.4,1-1c0-0.9-0.2-1.8-0.5-2.6c0.1-2.6,2.3-4.7,4.9-4.7c2.7,0,4.9,2.2,4.9,4.9c0,2.2-1.5,4.1-3.5,4.7   l-71.1,10.5c0,0,0,0-0.1,0c-0.1,0-0.1,0-0.2,0C103.1,123.2,100.9,121,100.9,118.3z M110.7,124.6l65-9.6c0,0,0,0,0,0   c0.5,0,0.9,0,1.4-0.1l20.9,37.3L110.7,124.6z',
      'M179.3,132.5c-6.4-4.1-11.6-1.9-13.7-0.6c-5.6-8.2-15.3-5-15.4-4.9c-0.5,0.2-0.8,0.8-0.6,1.3   c0.2,0.5,0.7,0.8,1.3,0.6c0.4-0.1,8.9-3,13.6,5c0.2,0.3,0.4,0.4,0.7,0.5c0.3,0,0.6-0.2,0.8-0.5C179.9,133.4,179.8,132.8,179.3,132.5z',
    ],
    cakeCherry: [
  ...
  const mod = (number: number, divisor: number) => ((number % divisor) + divisor) % divisor;

  const getRowCol = (cell: number) => [Math.floor(cell / columns), mod(cell, columns)];

  const diff = (row: number, column: number, nextRow: number, nextColumn: number, rows: number, columns: number) => {
  ...
  geese.forEach((goose: any, gooseIndex: number) => {
    const active = goose.length > 0;
    let s = step;
    if (!active) {
      // Find the last step where the goose existed.
      while (s > 0 && !goose.length) {
        goose = (replay.steps[--s] as any)[0].observation.geese[gooseIndex];
      }
    }
    goose.forEach((position: any, segmentIndex: number) => {
      if (!active && position in geesePositions) return;
      const [row, column] = getRowCol(position);
      const [previousRow, previousColumn] = segmentIndex === 0 ? [row, column] : getRowCol(goose[segmentIndex - 1]);
      const [nextRow, nextColumn] =
        segmentIndex === goose.length - 1 ? [row, column] : getRowCol(goose[segmentIndex + 1]);
      const [previousNorth, previousSouth, previousEast, previousWest] = diff(
        row,
        column,
        previousRow,
        previousColumn,
  ...
  const drawImage = (
    ...
    ctx.drawImage(canvas, sCol * cellSize, sRow * cellSize, cellSize, cellSize, 0, 0, cellSize, cellSize);
    ctx.restore();
  };
  ...
  for (let i = 0; i < rows * columns; i++) {
    ...
    c.strokeRect(cellOffset, cellOffset, cellSize - cellOffset * 2, cellSize - cellOffset * 2);
    c.restore();

    const drawPiece = (sRow: number, sCol: number, angle?: number, flip?: boolean) =>
      drawImage(bufferCanvas, c, sRow, sCol, row, col, angle, flip);

    // Draw Pieces.
    if (i in geesePositions) {
      const { active, index, head, tail, north, south, west, east } = geesePositions[i];
      ...
      if (head && tail) {
        ...
        // Curved Neck.
        drawPiece(2, index, east && south ? 90 : west && south ? 180 : west && north ? 270 : 0);
      }
