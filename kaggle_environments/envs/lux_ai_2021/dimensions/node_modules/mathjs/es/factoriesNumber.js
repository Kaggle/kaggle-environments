...
export var createIndex = /* #__PURE__ */factory('index', [], function () {
  return noIndex;
});
export var createMatrix = /* #__PURE__ */factory('matrix', [], function () {
  return noMatrix;
}); // FIXME: needed now because subset transform needs it. Remove the need for it in subset

export var createSubset = /* #__PURE__ */factory('subset', [], function () {
  return noSubset;
...
export { createReplacer } from './json/replacer'; // helper function to create a factory function for a function which only needs typed-function
