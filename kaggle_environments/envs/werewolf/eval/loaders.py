...
class GameResult:
    ...
    def _compute_costs(self, game_json, game_end_info):
        ...
        for i, agent_conf in enumerate(agents_config):
            # Handle both simple dict and structured object if strictify was used (though game_json is raw dict here usually)
