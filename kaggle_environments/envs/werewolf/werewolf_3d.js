function renderer({
            ...
            class BasicWorldDemo {
              ...
              _LoadModels(THREE, FBXLoader, SkeletonUtils, CSS2DObject) {
                ...
                fbxLoader.load('assets/Idle_stickman.fbx', (fbx) => {
                    const stickmanModel = this._NormalizeModel(fbx, THREE);
                    ...
                    for (let i = 0; i < numStickmen; i++) {
                      ...
                      const nameplate = this._createNameplate(names[i], URLS[brands[i]], CSS2DObject);
                    ...
                    this._FrameGroup(stickmanGroup, THREE);
                  },
                  undefined,
                  (error) => {
  ...
  const css = `
        ...
        .ui-container {
            ...
            pointer-events: auto; /* Enable pointer events for the UI */
        }
