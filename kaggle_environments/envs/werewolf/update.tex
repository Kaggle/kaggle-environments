...
\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{final_plots/werewolf/gte_evaluation.png}
  \caption{Werewolf leaderboard results evaluated by Game Theoretic Evaluation. \textbf{(A)} Role-specific contributions: The overall player skill (mean Net Rating) broken down into role-specific contributions. Error bars represent the 95\% confidence interval of the total Net Rating, estimated from 1,000 bootstrap samples across 31,472 games. \textbf{(B)} Bootstrap distribution: Distributions of Net Rating (95\% CI), with dashed lines denoting quartiles. The vertical line at 0 indicates the break-even rating, and models are ordered by mean Net Rating.}
