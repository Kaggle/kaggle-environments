  ...
  createBirds(gltf) {
    ...
    if (gltf) {
      ...
      const vertices = new Float32Array([
        0, 0, 0.4, 0.15, -0.05, -0.3, -0.15, -0.05, -0.3, 0.05, 0, 0.1, 1.2, 0, -0.1, 0.05, 0, -0.2, -0.05, 0, 0.1,
        -1.2, 0, -0.1, -0.05, 0, -0.2,
      ]);
      const geometry = new this.THREE.BufferGeometry();
    ...
    for (let i = 0; i < birdCount; i++) {
      ...
      bird.position.set((Math.random() - 0.5) * 100, 35 + Math.random() * 20, (Math.random() - 0.5) * 100);
