...
( function ( root, factory ) {
  ...
  if ( typeof define === 'function' && define.amd ) {
    ...
    // Handle both classic script and ES6 module contexts
    const globalRoot = root || (typeof window !== 'undefined' ? window : globalThis);
    globalRoot.VolumetricFire = factory( globalRoot );
