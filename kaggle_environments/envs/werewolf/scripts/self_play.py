...
def self_play_config(litellm_model_path, brand):
    logging.info(f"Starting game with model '{litellm_model_path}' and brand '{brand}'")
    ...
    logging.info(f"Agent configs: {json.dumps(agents_config, indent=4)}")
    config = {
        "actTimeout": 30,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--base_name", type=str, help="the base file name of .html, .json and .log", default="out")
