...
class UniversalPokerTest(parameterized.TestCase):
    ...
    def test_game_parameters(self):
        game = pyspiel.load_game(
            "universal_poker_proxy(betting=nolimit,numPlayers=2,stack=20000 20000,numRounds=4,blind=50 100,firstPlayer=2 1 1 1,numSuits=4,numRanks=13,numHoleCards=2,numBoardCards=0 3 1 1,bettingAbstraction=fullgame)"
        )
