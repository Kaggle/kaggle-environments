...
// Character Paths (based on 100x100 tiles), moved outside of the component for performance.
...
export const Renderer = ({ replay, step }: { replay: ReplayData; step: number }) => {
    ...
    return html`<canvas ref=${canvasRef} style=${{ width: '100%', height: '100%' }} />`;
};
