...
const { _getMovesFromBettingStringACPC, _getReadableMovesFromBettingStringACPC } = __testing;

testCases.forEach((test) => runTest(test, _getMovesFromBettingStringACPC));
readableTestCases.forEach((test) => runTest(test, _getReadableMovesFromBettingStringACPC));
