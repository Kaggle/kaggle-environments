 ...
 */ !(function () {
  ...
  function t() {
    function e(e) {
      ...
      function ge(e, n, t, r) {
          ...
          f = {
            ...
            '%U': function (e) {
              ...
              return a(t, (e = new Date(e.A + 1900, e.K, e.L))) < 0
                ? i(
                    Math.ceil(
                      (31 - t.getDate() + (ye(C(e.getFullYear()) ? M : R, e.getMonth() - 1) - 31) + e.getDate()) / 7
                    ),
                    2
                  )
                : 0 === a(t, n)
        ...
        for (c in ((t = t.replace(/%%/g, '\0\0')), f)) t.includes(c) && (t = t.replace(new RegExp(c, 'g'), f[c](r)));
        return (
          (t = t.replace(/\0\0/g, '%')),
          (l = t),
          (p = Array(V(l) + 1)),
            ...
            ? ((i = o = !1),
              e(() => {
                if (!v && ((o = !0), i)) {
                  ...
                  var e,
                    r = !1;
                  if ((E || ((e = be) && ((be = null), (n ? e.reject : e.resolve)(t), (r = !0))), n && !r)) throw t;
                }
              }),
              (i = !0),
              o ||
      ...
      var P,
        ...
        Me =
          (!(function () {
            ...
            (a || 'function' != typeof WebAssembly.instantiateStreaming || oe() || 'function' != typeof fetch
              ? r(t)
      ...
      function Ye(e) {
        (d || 0 < _ || (te = !0), d || 0 < _ || (l.onExit && l.onExit(e), (v = !0)), c(e, new j(e)));
      }
      if (
        ...
        (l.ccall = function (e, n, t, r, o) {
          ...
          var a = {
              string: function (e) {
                var n,
                  t = 0;
                return (null != e && 0 !== e && ((n = 1 + (e.length << 2)), (t = Y(n)), G(e, y, t, n)), t);
              },
              array: function (e) {
                var n = Y(e.length);
                return (h.set(e, n), n);
    ...
    var Te;
    ((Te = 'undefined' != typeof document && document.currentScript ? document.currentScript.src : void 0),
  ...
  function i(e) {
    if (
      (r.ccall('command', null, ['string'], [e], { async: 'undefined' != typeof IS_ASYNCIFY && /^go\b/.test(e) }),
      'quit' === e)
    ) {
      try {
        r.terminate();
  ...
  function f(e) {
    ('go' === (e = e.trim()).substring(0, 2) || 'setoption' === e.substring(0, 9) ? n.push(e) : i(e), c());
  }
  function l() {
  ...
  function p(t) {
    ...
    for (e = 0; e < t; ++e)
      !(function (e, n) {
        ...
        (function (n) {
          return function (e) {
            (++r, (o[n] = e), r === t && ((e = URL.createObjectURL(new Blob(o, { type: 'application/wasm' }))), u(e)));
          };
        })(e)
      );
  }
        ...
        e
          ? require.main === module
            ? ((s = require('path')),
              ...
              require('readline')
                ...
                .on('line', function (e) {
                  e && (r.processCommand ? r.processCommand(e) : o.push(e), 'quit' === e) && process.exit();
                })
                .on('close', function () {
                  process.exit();
                })
          ...
          : ((e = self.location.hash.substr(1).split(',')),
            ...
            (onmessage =
              onmessage ||
              function (e) {
                if ((r.processCommand ? r.processCommand(e.data) : o.push(e.data), 'quit' === e.data))
                  try {
                    self.close();
                  } catch (e) {}
              })))
