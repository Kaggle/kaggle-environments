"""Run a full Hive game with LLM agents for local integration testing.

Usage:
    GEMINI_API_KEY=... uv run python -m \\
        kaggle_environments.envs.open_spiel_env.games.hive.test_llm_game
"""
...
def run_llm_game():
    ...
    print("Running Hive game with LLM agents...")
